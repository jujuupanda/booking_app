...
import '../../utils/general/pop_up.dart';
...
class _CreateSchedulePageState extends State<CreateSchedulePage>
  ...
  _deleteExschool(String id) {
    _exschoolBloc = context.read<ExtracurricularBloc>();
    _exschoolBloc.add(DeleteExtracurricular(id));
  }
  ...
  @override
  void initState() {
    exschoolNameController = TextEditingController();
          ...
          body: Column(
            children: [
              const HeaderDetailPage(
                pageName: "Tambah Jadwal Kegiatan",
              ),
              TabBar(
